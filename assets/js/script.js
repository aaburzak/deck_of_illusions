...
const deck = [
  ...
  {
    card_Name: "A Knight & Four Guards",
  ...
  },
  {
    ...
    card_Description: "Druids dwell in forests and other secluded wilderness locations, where they protect the natural world from monsters and the encroachment of civilization. Some are tribal shamans who heal the sick, pray to animal spirits, and provide spiritual guidance.",
  },
  {
    card_Name: "Cloud Giant",
    card_Image: "assets/images/cloudGiant.png",
    card_Description: "Cloud giants’ skin ranges in color from milky white to light sky blue. Their hair is silvery white or brass, and their eyes are iridescent blue. Adult males are about 18 feet tall and weigh about 5,000 pounds. ",
  },
  {
    card_Name: "Succubus (Incubus)",
    card_Image: "assets/images/succubus.png",
    card_Description: "When uncovered in her true form, a succubus appear as a stunningly beautiful woman of statuesque build and perfect figure, with flawless skin and red or raven-black hair, but also clawed fingers and large dark-hued or reddish bat-like wings mounted on their backs. Their eyes are said to smolder with sinister desire.  Small horns or a tail might also be seen. Succubi stand on average around 6 feet (1.8 meters) tall and weighed 125 pounds (57 kilograms).",
  },
  {
    card_Name: "Ettin",
    card_Image: "assets/images/ettin.png",
    card_Description: "At first glance, ettins seemed like relatively short members of other giant races, about 13 ft (4 m) tall, two-headed hill or stone giants, but upon closer examination even hill giants seemed civilized compared to them. They are hulking creatures with exceptionally broad shoulders, long arms, and great weight, reports of their heaviness ranging from around 1,000 lb (450 kg) to exceeding 5,000 lb (2,300 kg). Strangely, they are slightly lop-sided, the right side being slightly more muscular and well-developed than the left, although not enough to detract from their barbaric image.",
  },
  {
    card_Name: "Ogre Mage",
    card_Image: "assets/images/ogreMage.png",
    card_Description: "Ogres are hulking giants notorious for their quick tempers. When its rage is incited, an ogre lashes out in a frustrated tantrum until it runs out of objects or creatures to smash.  Occasionally, they learn magic.",
  },
  {
    card_Name: "Gnoll",
    card_Image: "assets/images/gnoll.png",
    card_Description: "Gnolls are feral, hyena-headed humanoids that attack without warning, slaughtering their victims and devouring their flesh.",
  },
  {
    card_Name: "Bugbear",
  ...
  {
    card_Name: "Archmage & Mage Apprentice",
  ...
  },
  {
    ...
    card_Description: "Ogres are hulking giants notorious for their quick tempers. When its rage is incited, an ogre lashes out in a frustrated tantrum until it runs out of objects or creatures to smash.",
  },
  {
    card_Name: "Orc",
  ...
  {
    card_Name: "Pixie",
    card_Image: "assets/images/pixie.png",
    card_Description: "It's a Druid!",
  },
  {
    card_Name: "Harpy",
    card_Image: "assets/images/harpy.png",
    card_Description: "It's a Druid!",
  },
  {
    card_Name: "kobold",
